      ...
      return (
        <tr>
          ...
          <td className="edit-td">
            <a href={'/pages/'+key._id.toString()}><i className="fa fa-table fa-fw" title="edit"/>Pages</a>
            <a href={'/pageProjects/update/'+key._id.toString()}><i className="fa fa-edit fa-fw" title="edit"/>Edit</a>
          </td>
        </tr>
      );
    });
...
module.exports = React.createClass({
  render: function () {
    ...
    return (
      <DefaultLayout title="PageProjects">
        <div id="wrapper">
          {/* Navigation */}
          ...
          <div id="page-wrapper">
            <div className="row row-same-height">
              <div className="col-xs-10 col-xs-height"><h3>Page Projects</h3></div>
              <div className="col-xs-2 col-xs-height col-middle"><a href="/PageProjects/create"
