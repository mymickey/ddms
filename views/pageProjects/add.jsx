...
module.exports = React.createClass({
  render: function () {
    ...
    return (
      <DefaultLayout title="Create Page Project">
        <div id="wrapper">
          {/* Navigation */}
          <Navigation></Navigation>
          <div id="page-wrapper">
            <div className="row row-same-height">
              <div className="col-xs-12 col-xs-height"><h3><a href="/pageProjects/">Page Projects</a> / Create a new page project</h3></div>
            </div>
            <form role="form" method="POST" action="/pageProjects/create">
