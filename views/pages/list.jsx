      ...
      return (
        <tr>
          ...
          <td className="edit-td">
            <a href={'/pages/update/'+key._id.toString()}><i className="fa fa-edit fa-fw" title="edit"/>Edit</a>
            <a href={'/pages/copy/'+key._id.toString()}><i className="fa fa-edit fa-copy" title="copy"/>Copy</a></td>
        </tr>
      );
    });
    return(
        ...
        <div id="wrapper">
          ...
          <div id="page-wrapper">
            <div className="row row-same-height">
              <div className="col-xs-10 col-xs-height"><h3><a href="/projects/">Projects</a> / Pages</h3></div>
              <div className="col-xs-2 col-xs-height col-middle"><a href={'/pages/create/'+projectid}
